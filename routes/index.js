...
router.get('/', function(req, res) {
  res.render('index', { title: 'Quiz-SLV', errors: []});
});
...
router.get('/quizes/:quizId(\\d+)/comments/:commentId(\\d+)/edit',    sessionController.loginRequired, commentController.edit);
router.put('/quizes/:quizId(\\d+)/comments/:commentId(\\d+)/update',  sessionController.loginRequired, commentController.update);
